...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/coinbase_wallet_sdk/coinbase_wallet_sdk.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/solana_wallet_adapter_ios/solana_wallet_adapter_ios.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/webcrypto/webcrypto.framework"
