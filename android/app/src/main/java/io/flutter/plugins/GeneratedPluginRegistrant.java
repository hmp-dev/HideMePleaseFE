...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.merigo.solana_wallet_adapter_android.SolanaWalletAdapterAndroidPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin solana_wallet_adapter_android, com.merigo.solana_wallet_adapter_android.SolanaWalletAdapterAndroidPlugin", e);
    }
    try {
