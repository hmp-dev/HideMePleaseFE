...
import 'package:mobile/features/app/presentation/cubit/app_cubit.dart' as _i29;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i21.AuthRemoteDataSource>(
        () => _i21.AuthRemoteDataSource(gh<_i8.Network>()));
    gh.lazySingleton<_i22.AuthRepository>(() => _i23.AuthRepositoryImpl(
          gh<_i21.AuthRemoteDataSource>(),
          gh<_i7.AuthLocalDataSource>(),
        ));
    gh.lazySingleton<_i24.EnableLocationCubit>(
        () => _i24.EnableLocationCubit(gh<_i13.ProfileRepository>()));
    gh.lazySingleton<_i25.NftCubit>(
        () => _i25.NftCubit(gh<_i10.NftRepository>()));
    gh.lazySingleton<_i26.ProfileCubit>(
        () => _i26.ProfileCubit(gh<_i13.ProfileRepository>()));
    gh.lazySingleton<_i27.SpaceCubit>(
        () => _i27.SpaceCubit(gh<_i16.SpaceRepository>()));
    gh.lazySingleton<_i28.WalletsCubit>(
        () => _i28.WalletsCubit(gh<_i19.WalletsRepository>()));
    gh.lazySingleton<_i29.AppCubit>(
        () => _i29.AppCubit(gh<_i22.AuthRepository>()));
    gh.lazySingleton<_i30.AuthCubit>(
        () => _i30.AuthCubit(gh<_i22.AuthRepository>()));
    return this;
  }
}
