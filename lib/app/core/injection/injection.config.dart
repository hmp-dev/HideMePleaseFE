...
import 'package:mobile/features/app/presentation/cubit/app_cubit.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i12.AuthRemoteDataSource>(
        () => _i12.AuthRemoteDataSource(gh<_i8.Network>()));
    gh.lazySingleton<_i13.AuthRepository>(() => _i14.AuthRepositoryImpl(
          gh<_i12.AuthRemoteDataSource>(),
          gh<_i7.AuthLocalDataSource>(),
        ));
    gh.lazySingleton<_i15.ProfileCubit>(
        () => _i15.ProfileCubit(gh<_i10.ProfileRepository>()));
    gh.lazySingleton<_i16.AppCubit>(
        () => _i16.AppCubit(gh<_i13.AuthRepository>()));
    gh.lazySingleton<_i17.AuthCubit>(
        () => _i17.AuthCubit(gh<_i13.AuthRepository>()));
    return this;
  }
}
