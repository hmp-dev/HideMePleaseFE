...
import 'package:mobile/features/alarm/infrastructure/repositories/alarms_repository.dart'
    as _i28;
import 'package:mobile/features/app/presentation/cubit/app_cubit.dart' as _i48;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i40.NftCubit>(
        () => _i40.NftCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i41.NickNameCubit>(
        () => _i41.NickNameCubit(gh<_i15.ProfileRepository>()));
    gh.lazySingleton<_i42.ProfileCubit>(
        () => _i42.ProfileCubit(gh<_i15.ProfileRepository>()));
    gh.lazySingleton<_i43.SettingsCubit>(
        () => _i43.SettingsCubit(gh<_i18.SettingsRepository>()));
    gh.lazySingleton<_i44.SpaceBenefitsCubit>(
        () => _i44.SpaceBenefitsCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i45.SpaceCubit>(
        () => _i45.SpaceCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i46.SpaceDetailCubit>(
        () => _i46.SpaceDetailCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i47.WalletsCubit>(
        () => _i47.WalletsCubit(gh<_i24.WalletsRepository>()));
    gh.lazySingleton<_i48.AppCubit>(
        () => _i48.AppCubit(gh<_i30.AuthRepository>()));
    gh.lazySingleton<_i49.AuthCubit>(
        () => _i49.AuthCubit(gh<_i30.AuthRepository>()));
    return this;
  }
}
