...
import 'package:web3modal_flutter/widgets/avatars/wepin_wallet_avatar.dart';
...
class WepinWalletListItem extends StatelessWidget {
  const WepinWalletListItem({
    super.key,
    required this.title,
    this.imageUrl,
    this.trailing,
            ...
            child: Stack(
              children: [
                Padding(
                    ...
                    child: Image.asset('assets/png/wepin_wallet.png')
