...
import 'package:mobile/app/core/services/live_activity_service.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i4.LiveActivityService>(() => _i4.LiveActivityService());
    ...
    gh.lazySingleton<_i37.ImageUploadService>(
        () => _i37.ImageUploadService(gh<_i11.Network>()));
    gh.lazySingleton<_i38.MemberDetailsCubit>(
        () => _i38.MemberDetailsCubit(gh<_i17.ProfileRepository>()));
    gh.lazySingleton<_i39.MembershipCubit>(
        () => _i39.MembershipCubit(gh<_i13.NftRepository>()));
    gh.lazySingleton<_i40.ModelBannerCubit>(
        () => _i40.ModelBannerCubit(gh<_i20.SettingsRepository>()));
    gh.lazySingleton<_i41.NearBySpacesCubit>(
        () => _i41.NearBySpacesCubit(gh<_i23.SpaceRepository>()));
    gh.lazySingleton<_i42.NftBenefitsCubit>(
        () => _i42.NftBenefitsCubit(gh<_i13.NftRepository>()));
    ...
    gh.lazySingleton<_i44.NickNameCubit>(
        () => _i44.NickNameCubit(gh<_i17.ProfileRepository>()));
    gh.lazySingleton<_i45.NotificationsCubit>(
        () => _i45.NotificationsCubit(gh<_i20.SettingsRepository>()));
    gh.lazySingleton<_i46.ProfileCubit>(
        () => _i46.ProfileCubit(gh<_i17.ProfileRepository>()));
    gh.lazySingleton<_i47.SettingsCubit>(
        () => _i47.SettingsCubit(gh<_i20.SettingsRepository>()));
    gh.lazySingleton<_i48.SpaceBenefitsCubit>(
        () => _i48.SpaceBenefitsCubit(gh<_i23.SpaceRepository>()));
    gh.lazySingleton<_i49.SpaceCubit>(
        () => _i49.SpaceCubit(gh<_i23.SpaceRepository>()));
    gh.lazySingleton<_i50.SpaceDetailCubit>(
        () => _i50.SpaceDetailCubit(gh<_i23.SpaceRepository>()));
    gh.lazySingleton<_i51.WalletsCubit>(
        () => _i51.WalletsCubit(gh<_i27.WalletsRepository>()));
    gh.lazySingleton<_i52.AppCubit>(
        () => _i52.AppCubit(gh<_i30.AuthRepository>()));
    gh.lazySingleton<_i53.AuthCubit>(() => _i53.AuthCubit(
          gh<_i30.AuthRepository>(),
          gh<_i10.AuthLocalDataSource>(),
        ));
    gh.factory<_i54.EventCategoryCubit>(
        () => _i54.EventCategoryCubit(gh<_i35.EventCategoryRepository>()));
    return this;
  }
}
