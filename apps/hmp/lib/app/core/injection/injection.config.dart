...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i23.SubmitLocationCubit>(
        () => _i23.SubmitLocationCubit(gh<_i15.ProfileRepository>()));
    gh.lazySingleton<_i24.WalletsRemoteDataSource>(
        () => _i24.WalletsRemoteDataSource(gh<_i9.Network>()));
    gh.lazySingleton<_i25.WalletsRepository>(
        () => _i26.WalletsRepositoryImpl(gh<_i24.WalletsRemoteDataSource>()));
    gh.lazySingleton<_i27.AuthRemoteDataSource>(
        () => _i27.AuthRemoteDataSource(gh<_i9.Network>()));
    gh.lazySingleton<_i28.AuthRepository>(() => _i29.AuthRepositoryImpl(
          gh<_i27.AuthRemoteDataSource>(),
          gh<_i8.AuthLocalDataSource>(),
        ));
    gh.lazySingleton<_i30.BenefitRedeemCubit>(
        () => _i30.BenefitRedeemCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i31.ChatRemoteDataSource>(
        () => _i31.ChatRemoteDataSource(gh<_i9.Network>()));
    gh.lazySingleton<_i32.ChatRepository>(
        () => _i33.ChatRepositoryImpl(gh<_i31.ChatRemoteDataSource>()));
    gh.lazySingleton<_i34.CommunityCubit>(
        () => _i34.CommunityCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i35.CommunityDetailsCubit>(
        () => _i35.CommunityDetailsCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i36.CommunityRankingsCubit>(
        () => _i36.CommunityRankingsCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i37.EnableLocationCubit>(
        () => _i37.EnableLocationCubit(gh<_i15.ProfileRepository>()));
    gh.lazySingleton<_i38.MembershipCubit>(
        () => _i38.MembershipCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i39.NearBySpacesCubit>(
        () => _i39.NearBySpacesCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i40.NftBenefitsCubit>(
        () => _i40.NftBenefitsCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i41.NftCubit>(
        () => _i41.NftCubit(gh<_i11.NftRepository>()));
    gh.lazySingleton<_i42.NickNameCubit>(
        () => _i42.NickNameCubit(gh<_i15.ProfileRepository>()));
    gh.lazySingleton<_i43.NotificationsCubit>(
        () => _i43.NotificationsCubit(gh<_i18.SettingsRepository>()));
    ...
    gh.lazySingleton<_i45.SettingsCubit>(
        () => _i45.SettingsCubit(gh<_i18.SettingsRepository>()));
    gh.lazySingleton<_i46.SpaceBenefitsCubit>(
        () => _i46.SpaceBenefitsCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i47.SpaceCubit>(
        () => _i47.SpaceCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i48.SpaceDetailCubit>(
        () => _i48.SpaceDetailCubit(gh<_i21.SpaceRepository>()));
    gh.lazySingleton<_i49.WalletsCubit>(
        () => _i49.WalletsCubit(gh<_i25.WalletsRepository>()));
    gh.lazySingleton<_i50.AppCubit>(
        () => _i50.AppCubit(gh<_i28.AuthRepository>()));
    gh.lazySingleton<_i51.AuthCubit>(
        () => _i51.AuthCubit(gh<_i28.AuthRepository>()));
    return this;
  }
}
