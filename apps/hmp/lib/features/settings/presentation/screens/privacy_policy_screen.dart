...
① 개인정보 수집 및 이용목적
	...
	•	앱 내 서비스 제공 및 본인인증 등을 위한 목적으로 개인정보를 처리합니다.
	•	기타 회사의 정상적인 영업에 관계된 행위의 목적으로 개인정보를 처리합니다.

② 수집 및 이용하는 개인정보 항목

	•	본인인증을 위한 성명, 생년월일, 연락처
	•	로그인을 위한 이메일
	•	서비스 이용을 위한 위치정보
...
이 개인정보처리방침은 2024.07.01.부터 적용되며, 법령 및 방침에 따른 변경내용의 추가, 삭제 및 정정이 있는 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.
