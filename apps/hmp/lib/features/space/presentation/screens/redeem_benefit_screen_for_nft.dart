...
// class RedeemBenefitScreenForNft extends StatefulWidget {
//   const RedeemBenefitScreenForNft({
//     super.key,
...
//       context,
//       MaterialPageRoute(
//         builder: (_) => RedeemBenefitScreenForNft(
...
//   @override
//   State<RedeemBenefitScreenForNft> createState() =>
//       _RedeemBenefitScreenForNftState();
// }

// class _RedeemBenefitScreenForNftState extends State<RedeemBenefitScreenForNft> {
...
//         .onGetNftBenefits(tokenAddress: widget.tokenAddress);
//   }
...
//       listener: (context, nftBenefitsState) {},
//       builder: (context, nftBenefitsState) {
...
//               });
//               onBenefitRedeemSuccess(
//                   selectedBenefit ?? const BenefitEntity.empty());
...
//                       nftBenefitsState.nftBenefitList.isEmpty
//                           ? const SizedBox.shrink()
//                           : Column(
//                               children: [
//                                 buildSpaceNameRowWithSelectedNftSpaceName(context,
//                                     nftBenefitsState.nftBenefitList[0]),
//                                 widget.isMatchedSpaceFound != null &&
//                                         widget.isMatchedSpaceFound == false
//                                     ? const NotInSpaceCanSpaceCannotUseBenefit()
//                                     : const SizedBox.shrink(),
//                                 const SizedBox(height: 24),
//                                 if (nftBenefitsState.isSubmitSuccess ||
...
//                                                   .tokenAddress),
//                                           isButtonEnabled: nftBenefitsState
//                                                   .benefitGroupEntity
//                                                   .benefits[selectedPageIndex]
//                                                   .state ==
//                                               "available",
...
//   Row buildSpaceNameRowWithSelectedNftSpaceName(
//     BuildContext context,
